...
* React Javascript is a free front-end library for building UI components and it solves the problem of needing to explicitly specify how to update presentation on change of state and making practical the creating of reusable, composable components.
2. Describe component state.
* Compontent state is how you data is passed and how it is stored so later it can be use in your code.
3. Describe props.
